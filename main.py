...
if __name__ == '__main__':  # see config file for settings
    ...
    if config.deeplearning:
        ...
        # Florian Liszt auskommentiert und ersetzt durch
        else:
        ...
        #else:
        #    if learning_config.get("do hyperparameter sensitivity analysis", False):
        #        runs = len(learning_config["hyperparameter tuning"][1])
        #    else:
        #        runs = 1
        #    for i in range(runs):
        #        deep_learning = Deeplearning(config, learning_config, i)
        #        deep_learning.training_or_testing(i)
        #    if learning_config.get("do hyperparameter sensitivity analysis", False): plotting.plot_hyp_para_tuning()
